...
TEST_CASE("Euclidian distance")
{
    ...
    graph::Vertex<double_t, double_t> target(1, { 3, 4 });
...
{
    graph::Vertex<uint32_t, uint32_t, bool, 5> source(0, { 1, 0, 1, 1, 0 });
    graph::Vertex<uint32_t, uint32_t, bool, 5> target(1, { 0, 0, 1, 0, 1 });
